<template>
  <div class="exam">
    <el-table :data="pagination.records" border>
      ...
      <el-table-column fixed="right" label="操作" width="356">
        <template slot-scope="scope">
          <el-button type="success" @click="getExamDetail(scope.row.examCode, scope.row.paperId)">
            <i class="el-icon-s-order"></i> Details</el-button>
      ...
      <section class="update">
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-form-item label="考试日期">
            <el-col :span="11">
              <el-date-picker type="date" placeholder="选择日期" v-model="form.examDate" value-format="yyyy-MM-dd"
            ...
            <el-collapse-item class="header" name="0">
              ...
              <template slot="title">
                <div class="title">
                  ...
                  <span class="time">{{ score[0] + score[1] + score[2] }}分 /
...
export default {
  ...
  methods: {
    ...
    deleteRecord(examCode) {
      this.$confirm("确定删除该记录吗,该操作不可逆！！！", "警告", {
