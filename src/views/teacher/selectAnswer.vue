  ...
  <div class="exam">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="科目名称">
        <el-input v-model="subject" placeholder="科目名称"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="getAnswerInfo" style="font-size: 20px;margin-left: 20px; margin-top: -3px;"
          icon="el-icon-search"></el-button>
      </el-form-item>
    </el-form>

    <el-table :data="pagination.records" border :row-class-name="tableRowClassName">
      <el-table-column fixed="left" prop="subject" label="科目名称" width="180"></el-table-column>
      ...
      <el-table-column fixed="right" label="操作">
        <template slot-scope="scope" style="justify-content: space-between;">
          <el-button @click="toEdit(scope.row.type, scope.row.questionId)" type="primary"> 编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
      :current-page="pagination.current" :page-sizes="[4, 7, 9]" :page-size="pagination.size"
